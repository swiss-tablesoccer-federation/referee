...
|[Deutsch](./interpretation-stf-de.md)| Francais | [Italiano](./interpretation-stf-it.md) | [English](interpretation-stf-en.md) | [Türkçe](./interpretation-stf-tr.md) |
|---|--------------------------------------|---------------------------------------|------------------------------------|--------------------------------------|
...
Comportement en tant qu'arbitre :
Si un arbitre remarque qu'un joueur exploite les limites ou les dépasse même partiellement, il peut le signaler au joueur lors d'une pause. Les joueurs peuvent alors faire appel à un chronométreur.
...
Une balle définie au début dans l'approvisionnement en balles est en principe considérée comme jouable pendant toute la durée du match.
Une balle ne peut être remplacée que si elle présente un défaut visible et ne peut donc plus être jouée (par exemple, une bosse importante qui