...
|[Deutsch](./interpretation-stf-de.md)| [Francais](./interpretation-stf-fr.md) | [Italiano](./interpretation-stf-it.md) | English | [Türkçe](./interpretation-stf-tr.md) |
|---|--------------------------------------|---------------------------------------|------------------------------------|--------------------------------------|
...
### Interpretations
#### 01: No time fouls without a stopwatch
...
If a referee notices that a player is pushing the limits or even exceeding them in some cases, they can point this out to the player during a break. The players can then call in a timekeeper.

#### 02: The timekeeper only penalizes time violations.
...
#### 03: Balls are generally playable for an entire game
A ball specified at the beginning in the ball supply is generally considered playable for the entire game.
A ball can only be replaced if it has a visible defect and can no longer be played (e.g., a large dent that